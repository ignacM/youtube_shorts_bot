...
def uploader():
    """
    answer, nameofvid, and howmany have been excluded as input to reduce complexity. They can be added back.
    time.sleep(6) has also been excluded
    :return:
    """
    options = webdriver.ChromeOptions()
    # options.add_experimental_option('excludeSwitches', ['enable-logging'])
    options.add_argument("--log-level=3")
    options.add_argument("user-data-dir=C:\\Users\\ignac\\AppData\\Local\\Google\\Chrome Beta\\User Data\\")
